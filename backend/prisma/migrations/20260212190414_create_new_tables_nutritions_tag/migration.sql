...
-- CreateIndex
CREATE UNIQUE INDEX "recipe_tag_name_key" ON "recipe_tag"("name");
...
-- AddForeignKey
ALTER TABLE "_RecipeToRecipeTag" ADD CONSTRAINT "_RecipeToRecipeTag_B_fkey" FOREIGN KEY ("B") REFERENCES "recipe_tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
